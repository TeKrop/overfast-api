...
@pytest.mark.parametrize(
    ("player_html_data", "player_career_json_data", "gamemode", "platform", "hero"),
    [
...
def test_get_player_stats(
    ...
    with patch.object(
        ...
        response = client.get(f"/players/TeKrop-2217/stats/career{params}")
...
def test_get_player_stats_blizzard_error():
    with patch.object(
        ...
        response = client.get(
            f"/players/TeKrop-2217/stats/career?gamemode={PlayerGamemode.QUICKPLAY}"
        )
