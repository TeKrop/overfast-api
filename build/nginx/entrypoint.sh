...
envsubst '${VALKEY_HOST} ${VALKEY_PORT} ${CACHE_TTL_HEADER}' < /usr/local/openresty/lualib/valkey_handler.lua.template > /usr/local/openresty/lualib/valkey_handler.lua
